	 	...
	 	return(
	 		<div style ={productDivStyle}>
					...
					<div style={{"fontSize":"12px","marginTop":'5px'}}> 
						&#8377;{this.props.product.details.variants[0].priceDetails.listedPrice}&nbsp;
						<span style={{"textDecoration":"line-through",'fontWeight': '300',"fontSize":"10px"}}>{this.props.product.details.variants[0].priceDetails.labelPrice}&nbsp;</span> 
						<span style={{"fontSize":"10px","color":"green"}}>{this.props.product.details.variants[0].priceDetails.percentOff}% OFF&nbsp;</span>
					</div>
